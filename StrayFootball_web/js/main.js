    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 100) {
                    if (role == "教练员" || role == "球员" || role == "队医" || role == "管理员") {
                        $("#myPhoto").attr("src", data.data.image).attr('onerror', "this.src='images/main/member.gif'");
                        $("#account").html(data.data.account);
                        setCookie(_account, data.data.account);
                        account = data.data.account;
                    } else {
                        $("#myPhoto").attr("src", "images/main/member.gif");
                    }
        ...
        if (role == "教练员") {
            ...
            $("#roule").html(role);
            // $("#myPhoto").attr("src", photo).attr('onerror', "this.src='images/main/member.gif'");
        } else if (role == "球员") {
            $(".player").show();
            $("#account").html(account);
            $("#roule").html(role);
